    ...
    */
    ...
    Daw.prototype.bufferTracks = function(cb) {
        ...
        loadBuffer(sources[this.buffered], this.ctx, function(buffer) {
            ...
            self.tracks.push({
                'buffer': buffer,
                'name': sources[self.buffered].split('/').pop().split('-').pop()
            });
            self.buffered++;
    ...
    const data = [{"name":"Space_Oddity","tracks":["Space_Oddity/Acous_Gtr.mp3","Space_Oddity/Bass_&_Drums.mp3","Space_Oddity/Bck_vox.mp3","Space_Oddity/Flute_&_Cello.mp3","Space_Oddity/Mellotron.mp3","Space_Oddity/Strings.mp3","Space_Oddity/Stylophone.mp3","Space_Oddity/Vox.mp3"]},{"name":"The_Hand_that_feeds","tracks":["The_Hand_that_feeds/THTF 01 Intro.mp3","The_Hand_that_feeds/THTF 02 Filtered Intro.mp3","The_Hand_that_feeds/THTF 03 Synth.mp3","The_Hand_that_feeds/THTF 04 End Synth Riff.mp3","The_Hand_that_feeds/THTF 05 End Synth Seq.mp3","The_Hand_that_feeds/THTF 06 Backing Vox.mp3","The_Hand_that_feeds/THTF 07 Percussion.mp3","The_Hand_that_feeds/THTF 08 Lead Vocals.mp3","The_Hand_that_feeds/THTF 09 Melodic Guitar.mp3","The_Hand_that_feeds/THTF 10 Riff Guitar.mp3","The_Hand_that_feeds/THTF 11 Synthetic Perc.mp3","The_Hand_that_feeds/THTF 12 Bass.mp3","The_Hand_that_feeds/THTF 13 Ambience.mp3","The_Hand_that_feeds/THTF 14 Drum Comp.mp3","The_Hand_that_feeds/THTF 15 Perc Loop 1.mp3","The_Hand_that_feeds/THTF 16 Toms.mp3","The_Hand_that_feeds/THTF 17 Synth Textures.mp3"]}];

    const sources = data[1].tracks;
